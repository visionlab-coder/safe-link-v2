...
const commonWords: Record<string, string> = {
    ...
    "all": "올", "any": "애니", "no": "노", "not": "낫", "yes": "예스",
    "ok": "오케이", "okay": "오케이",
    "hello": "헬로", "hi": "하이", "please": "플리즈",
    "thank": "땡크", "thanks": "땡스", "sorry": "쏘리",
    "good": "굿", "bad": "배드", "new": "뉴", "old": "올드",
    "big": "빅", "small": "스몰", "long": "롱", "short": "숏",
    "high": "하이", "low": "로우", "hot": "핫", "cold": "콜드",
    "do": "두", "don't": "돈트", "can": "캔", "can't": "캔트",
    "will": "윌", "won't": "원트", "must": "머스트", "should": "슈드",

    // ── 동사 ──
    "go": "고", "come": "컴", "get": "겟", "put": "풋", "take": "테이크", "eat": "이트", "eating": "이팅",
    "make": "메이크", "give": "기브", "keep": "킵", "let": "렛", "set": "셋",
    "run": "런", "walk": "워크", "stand": "스탠드", "sit": "싯",
    "hold": "홀드", "turn": "턴", "look": "룩", "see": "씨", "watch": "워치",
    "hear": "히어", "call": "콜", "tell": "텔", "say": "세이", "ask": "애스크",
    "try": "트라이", "use": "유즈", "need": "니드", "want": "원트",
    "know": "노우", "think": "씽크", "feel": "필", "find": "파인드",
    "show": "쇼", "help": "헬프", "send": "센드", "bring": "브링",
    "wear": "웨어", "remove": "리무브", "install": "인스톨",
    "check": "체크", "clean": "클린", "move": "무브", "lift": "리프트",
    "push": "푸쉬", "pull": "풀", "open": "오픈", "close": "클로즈",
    "lock": "록", "unlock": "언록", "load": "로드", "unload": "언로드",
    "start": "스타트", "stop": "스톱", "finish": "피니시", "complete": "컴플리트",
    "begin": "비긴", "end": "엔드", "wait": "웨이트", "stay": "스테이",
    "leave": "리브", "enter": "엔터", "exit": "엑시트", "pass": "패스",
    "follow": "팔로우", "lead": "리드", "carry": "캐리", "drop": "드롭",
    "pick": "픽", "place": "플레이스", "hang": "행", "tie": "타이",
    "fasten": "패스튼", "secure": "시큐어", "tighten": "타이튼",
    "loosen": "루슨", "connect": "커넥트", "disconnect": "디스커넥트",
    "attach": "어태치", "detach": "디태치", "mark": "마크",
    "report": "리포트", "confirm": "컨펌", "verify": "베리파이",
    "inspect": "인스펙트", "observe": "옵저브", "maintain": "메인테인",
    "repair": "리페어", "replace": "리플레이스", "fix": "픽스",
    "protect": "프로텍트", "prevent": "프리벤트", "avoid": "어보이드",
    "evacuate": "이배큐에이트", "escape": "이스케이프", "rescue": "레스큐",
    "beware": "비웨어", "alert": "얼러트", "notify": "노티파이",

    // ── 명사: 안전 ──
    "safety": "세이프티", "helmet": "헬멧", "danger": "데인저", "warning": "워닝",
    "caution": "코션", "hazard": "해저드", "risk": "리스크",
    "accident": "액시던트", "incident": "인시던트", "injury": "인저리",
    "emergency": "이머전시", "alarm": "알람",
    "fall": "폴", "falling": "폴링", "slip": "슬립", "trip": "트립",
    "hit": "히트", "cut": "커트", "burn": "번", "crush": "크러쉬",
    "shock": "쇼크", "collapse": "콜랩스", "explosion": "익스플로전",
    "leak": "리크", "spill": "스필", "exposure": "익스포저",
    "harness": "하니스", "lanyard": "랜야드", "anchor": "앵커",
    "hard": "하드", "hat": "햇", "vest": "베스트",
    "gloves": "글러브즈", "boots": "부츠", "glasses": "글래시즈",
    "goggles": "고글즈", "mask": "마스크", "respirator": "레스피레이터",
    "earplugs": "이어플러그", "shield": "쉴드",
    "guardrail": "가드레일", "barrier": "배리어", "fence": "펜스",
    "net": "넷", "cover": "커버", "sign": "사인", "label": "라벨",
    "hospital": "호스피탈", "first": "퍼스트", "aid": "에이드",
    "stretcher": "스트레처", "extinguisher": "엑스팅귀셔",
    "protection": "프로텍션", "equipment": "이큅먼트",
    "inspection": "인스펙션", "permit": "퍼밋",

    // ── 명사: 건설 ──
    "work": "워크", "worker": "워커", "working": "워킹",
    "site": "사이트", "area": "에어리어", "zone": "존",
    "floor": "플로어", "level": "레벨", "height": "하이트",
    "ground": "그라운드", "surface": "서피스",
    "basement": "베이스먼트", "underground": "언더그라운드",
    "rebar": "리바", "concrete": "콘크리트", "steel": "스틸", "iron": "아이언",
    "wood": "우드", "brick": "브릭", "glass": "글래스", "stone": "스톤",
    "cement": "시멘트", "mortar": "모르타르", "grout": "그라우트",
    "formwork": "폼워크", "scaffolding": "스캐폴딩", "scaffold": "스캐폴드",
    "shoring": "쇼링", "bracing": "브레이싱",
    "crane": "크레인", "ladder": "래더", "platform": "플랫폼",
    "beam": "빔", "column": "컬럼", "slab": "슬래브", "wall": "월",
    "roof": "루프", "foundation": "파운데이션", "trench": "트렌치",
    "pile": "파일", "footing": "풋팅",
    "bolt": "볼트", "nut": "넛", "screw": "스크류", "nail": "네일",
    "wire": "와이어", "cable": "케이블", "rope": "로프",
    "pipe": "파이프", "valve": "밸브", "duct": "덕트",
    "panel": "패널", "plate": "플레이트", "bar": "바",
    "tool": "툴", "machine": "머신", "device": "디바이스",
    "excavator": "엑스카베이터", "bulldozer": "불도저", "forklift": "포크리프트",
    "dump": "덤프", "truck": "트럭", "mixer": "믹서", "pump": "펌프",
    "hoist": "호이스트", "winch": "윈치", "jack": "잭",
    "drill": "드릴", "saw": "소", "grinder": "그라인더", "cutter": "커터",
    "welder": "웰더", "generator": "제너레이터", "compressor": "컴프레서",
    "demolition": "데몰리션", "asbestos": "아스베스토스", "toxic": "톡식",
    "ventilation": "벤틸레이션", "dehydration": "디하이드레이션",
    "assembly": "어셈블리", "briefing": "브리핑",
    "foreman": "포맨", "operator": "오퍼레이터",
    "manager": "매니저", "supervisor": "슈퍼바이저", "engineer": "엔지니어",
    "signal": "시그널", "spotter": "스파터",
    "fire": "파이어", "water": "워터", "power": "파워", "gas": "가스",
    "electric": "일렉트릭", "electrical": "일렉트리컬",
    "voltage": "볼티지", "current": "커런트", "grounding": "그라운딩",
    "circuit": "서킷", "breaker": "브레이커", "fuse": "퓨즈",
    "insulation": "인슐레이션", "insulating": "인슐레이팅",

    // ── 명사: 기타 ──
    "person": "퍼슨", "people": "피플", "man": "맨", "men": "멘",
    "head": "헤드", "hand": "핸드", "eye": "아이", "ear": "이어",
    "body": "바디", "back": "백", "foot": "풋", "feet": "핏",
    "point": "포인트", "part": "파트", "side": "사이드",
    "top": "톱", "bottom": "바텀", "front": "프론트", "rear": "리어",
    "inside": "인사이드", "outside": "아웃사이드",
    "way": "웨이", "path": "패스", "road": "로드", "route": "루트",
    "door": "도어", "gate": "게이트", "window": "윈도우",
    "room": "룸", "office": "오피스", "building": "빌딩",
    "location": "로케이션", "position": "포지션", "direction": "디렉션",
    "condition": "컨디션", "situation": "시츄에이션", "operation": "오퍼레이션",
    "procedure": "프로시저", "regulation": "레귤레이션",
    "number": "넘버", "time": "타임", "day": "데이", "night": "나이트", "three": "쓰리", "four": "포",
    "five": "파이브", "six": "식스", "seven": "세븐", "eight": "에이트", "nine": "나인", "ten": "텐",
    "one": "원", "two": "투", "hundred": "헌드레드", "thousand": "사우전드",
    "experience": "익스피리언스", "practice": "프랙티스",
    "today": "투데이", "tomorrow": "투모로우",
    "morning": "모닝", "afternoon": "애프터눈", "evening": "이브닝",
    "hour": "아워", "minute": "미닛", "second": "세컨드",
    "weather": "웨더", "rain": "레인", "wind": "윈드", "snow": "스노우",
    "heat": "히트", "dust": "더스트", "noise": "노이즈",
    "entry": "엔트리",

    // ── 형용사/부사 ──
    "safe": "세이프", "unsafe": "언세이프",
    "heavy": "헤비", "light": "라이트",
    "strong": "스트롱", "weak": "위크",
    "fast": "패스트", "slow": "슬로우", "quick": "퀵",
    "wet": "웻", "dry": "드라이", "sharp": "샤프",
    "clean": "클린", "dirty": "더티",
    "full": "풀", "empty": "엠프티",
    "maximum": "맥시멈", "minimum": "미니멈",
    "only": "온리", "also": "올소", "very": "베리", "too": "투",
    "here": "히어", "there": "데어", "where": "웨어",
    "now": "나우", "then": "덴", "when": "웬",
    "this": "디스", "that": "댓", "these": "디즈", "those": "도즈",
    "your": "유어", "my": "마이", "our": "아워", "their": "데어",
    "his": "히즈", "her": "허", "its": "이츠",
    "left": "레프트", "right": "라이트", "up": "업", "down": "다운",
    "away": "어웨이", "out": "아웃", "off": "오프",
    "before": "비포", "after": "애프터", "during": "듀링",
    "above": "어보브", "below": "빌로우", "under": "언더", "over": "오버",
    "between": "비트윈", "around": "어라운드", "near": "니어",
    "without": "위다웃", "within": "위딘",
    "always": "올웨이즈", "never": "네버", "again": "어게인",
    "immediately": "이미디어틀리", "carefully": "케어풀리", "slowly": "슬로울리",
    "properly": "프라퍼리", "directly": "디렉틀리",
    "required": "리콰이어드", "prohibited": "프로히비티드", "mandatory": "맨데이터리",
    "authorized": "오소라이즈드", "restricted": "리스트릭티드",
    "temporary": "템포러리", "permanent": "퍼머넌트",

    // ── 번역 결과에 자주 등장하는 구/표현 ──
    "no entry": "노 엔트리", "keep out": "킵 아웃", "keep away": "킵 어웨이",
    "watch out": "워치 아웃", "look out": "룩 아웃",
    "shut down": "셧 다운", "shut off": "셧 오프",
    "turn off": "턴 오프", "turn on": "턴 온",
    "pick up": "픽 업", "put on": "풋 온", "take off": "테이크 오프",
    "at height": "앳 하이트", "on site": "온 사이트",

    // ── 건설 안전 특수 ──
    "welding": "웰딩", "drilling": "드릴링", "cutting": "커팅", "grinding": "그라인딩",
    "pouring": "포링", "curing": "큐어링", "lifting": "리프팅",
    "rigging": "리깅", "hoisting": "호이스팅", "erecting": "이렉팅",
    "shoring": "쇼링", "bracing": "브레이싱", "backfilling": "백필링",
    "excavation": "엑스카베이션", "grading": "그레이딩",
    "waterproofing": "워터프루핑", "insulating": "인슐레이팅",
    "painting": "페인팅", "plastering": "플라스터링",
    "plumbing": "플러밍", "wiring": "와이어링",

    // ── 테스트에서 발견된 누락 단어 ──
    "year": "이어", "years": "이어즈", "month": "먼스", "months": "먼스",
    "week": "위크", "weeks": "위크스", "days": "데이즈",
    "hours": "아워즈", "minutes": "미닛츠", "seconds": "세컨즈",
    "ago": "어고", "later": "레이터", "since": "신스", "until": "언틸",
    "been": "빈", "done": "던", "gone": "곤", "made": "메이드",
    "were": "워", "was": "워즈", "had": "해드", "has": "해즈", "have": "해브",
    "each": "이치", "every": "에브리", "other": "아더", "another": "어나더",
    "same": "세임", "different": "디퍼런트", "next": "넥스트", "last": "라스트",
    "own": "오운", "such": "서치", "than": "댄", "then": "덴",
    "just": "저스트", "still": "스틸", "even": "이븐", "back": "백",
    "most": "모스트", "much": "머치", "many": "매니", "more": "모어",
    "less": "레스", "few": "퓨", "some": "섬", "several": "세버럴",
    "enough": "이너프", "able": "에이블", "ready": "레디",
    "sure": "슈어", "clear": "클리어", "free": "프리",
    "line": "라인", "type": "타입", "form": "폼", "size": "사이즈",
    "name": "네임", "place": "플레이스", "case": "케이스",
    "thing": "씽", "things": "씽즈", "way": "웨이", "ways": "웨이즈",
    "hand": "핸드", "hands": "핸즈", "eye": "아이", "eyes": "아이즈",
    "face": "페이스", "head": "헤드", "body": "바디",
    "life": "라이프", "lives": "라이브즈", "world": "월드",
    "important": "임포턴트", "possible": "파서블", "necessary": "네세서리",
    "available": "어베일러블", "special": "스페셜", "general": "제너럴",
    "public": "퍼블릭", "private": "프라이빗", "local": "로컬",
    "national": "내셔널", "international": "인터내셔널",
    "about": "어바웃", "through": "스루", "across": "어크로스",
    "along": "얼롱", "into": "인투", "onto": "온투",
    "upon": "어폰", "toward": "투워드", "towards": "투워즈",
    "against": "어겐스트", "among": "어몽", "per": "퍼",
    "because": "비코즈", "however": "하우에버", "therefore": "데어포",
    "although": "올도", "while": "와일", "unless": "언레스",
    "whether": "웨더", "either": "이더", "neither": "니더",
    "both": "보스", "already": "올레디", "yet": "옛",
    "perhaps": "퍼햅스", "quite": "콰이트", "rather": "래더",
    "whose": "후즈", "whom": "훔", "which": "위치",
    "itself": "잇셀프", "himself": "힘셀프", "herself": "허셀프",
    "themselves": "뎀셀브즈", "ourselves": "아워셀브즈",
    "everything": "에브리씽", "everyone": "에브리원", "something": "섬씽",
    "someone": "섬원", "nothing": "나씽", "anything": "애니씽", "anyone": "애니원",
    "shutdown": "셧다운", "shoes": "슈즈", "shoe": "슈",
    "radius": "레이디어스", "swing": "스윙", "rotate": "로테이트",
    "rotating": "로테이팅", "reverse": "리버스", "reversing": "리버싱",
    "speed": "스피드", "limit": "리밋", "observe": "옵저브",
    "guide": "가이드", "assign": "어사인", "conduct": "컨덕트",
    "headcount": "헤드카운트", "ambulance": "앰뷸런스",
    "preserve": "프리저브", "scene": "씬",
    "confined": "컨파인드", "space": "스페이스",
    "oxygen": "옥시젠", "measure": "메져", "ventilate": "벤틸레이트",
    "chemical": "케미컬", "detector": "디텍터",
    "combustible": "컴버스터블", "flammable": "플래머블",
    "ignition": "이그니션", "source": "소스",
    "frostbite": "프로스트바이트", "heatstroke": "히트스트로크",
    "lightning": "라이트닝", "earthquake": "어스퀘이크",
    "mudslide": "머드슬라이드", "flood": "플러드",
    "icy": "아이시", "slippery": "슬리퍼리",
    "hydrated": "하이드레이티드", "stretch": "스트레치",
    "uniform": "유니폼", "properly": "프라퍼리",
    "wash": "워시", "hands": "핸즈", "break": "브레이크", "breaks": "브레이크스",
    "rest": "레스트", "drink": "드링크", "plenty": "플렌티",
    "illness": "일니스", "symptom": "심프텀", "symptoms": "심프텀즈",
    "load": "로드", "secure": "시큐어", "securing": "시큐어링",
    "collision": "콜리전", "anti-collision": "안티콜리전",
    "pedestrian": "페데스트리안", "walkway": "워크웨이",
    "marking": "마킹", "zone": "존",
};
