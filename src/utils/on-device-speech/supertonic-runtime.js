// Vendored from supertone-inc/supertonic web/helper.js (MIT).
...
export function configureRuntimeForLatency() {
    const hardwareThreads = globalThis.navigator?.hardwareConcurrency || 4;
    ort.env.wasm.numThreads = Math.max(1, Math.min(8, hardwareThreads - 1));
