...
const i18n: Record<string, { title: string; pledge: string; sign: string; clear: string; submit: string; success: string; back: string; loading: string; already: string; description: string; content: string; todayContent: string; hint: string; missingSite: string; submitFailed: string; recorded: string }> = {
  ...
  km: { title: "ការប្តេជ្ញាសុវត្ថិភាព TBM", pledge: "ខ្ញុំបានយល់ច្បាស់អំពីខ្លឹមសារសុវត្ថិភាព TBM ថ្ងៃនេះ ហើយសន្យាថានឹងគោរពបទបញ្ជាសុវត្ថិភាពទាំងអស់ពេលធ្វើការ។", sign: "សូមចុះហត្ថលេខាខាងក្រោម", clear: "សម្អាត", submit: "បញ្ជូនហត្ថលេខា", success: "ប្តេជ្ញារួចរាល់", back: "ត្រឡប់ក្រោយ", loading: "កំពុងដំណើរការ...", already: "បានប្តេជ្ញារួចហើយ", description:"សូមពិនិត្យខ្លឹមសារប្តេជ្ញាសុវត្ថិភាព និងចុះហត្ថលេខា។", content:"ខ្លឹមសារប្តេជ្ញា", todayContent:"ខ្លឹមសារ TBM ថ្ងៃនេះ", hint:"សូមចុះហត្ថលេខាដោយម្រាមដៃ ឬប៊ិច", missingSite:"មិនមានព័ត៌មានការដ្ឋានទេ។ សូមទាក់ទងអ្នកគ្រប់គ្រង។", submitFailed:"បញ្ជូនមិនបានសម្រេច", recorded:"ហត្ថលេខារបស់អ្នកត្រូវបានកត់ត្រាក្នុងខ្សែសវនកម្ម" },
