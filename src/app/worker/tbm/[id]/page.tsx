...
const uiText: Record<string, any> = {
    ...
    km: { title: "សេចក្តីណែនាំសុវត្ថិភាព", original: "អត្ថបទដើម (ភាសាកូរ៉េ)", translated: "ការបកប្រែ", voice: "ស្តាប់សំឡេង", signHere: "សូមចុះហត្ថលេខានៅទីនេះ", clear: "សម្អាត", confirm: "✍️ បញ្ជាក់ និងចុះហត្ថលេខា", signed: "✓ បានចុះហត្ថលេខារួចហើយ!", translating: "កំពុងបកប្រែ...", noTBM: "មិនមានសេចក្តីណែនាំថ្ងៃនេះទេ។", mustSign: "តើអ្នកចង់ចាកចេញដោយមិនចុះហត្ថលេខាឬ?", alreadySigned: "អ្នកបានចុះហត្ថលេខារួចហើយថ្ងៃនេះ។", back: "ត្រឡប់ក្រោយ", pron: "ការបញ្ចេញសំឡេង", rev: "បកប្រែត្រឡប់", listenFirst: "សូមស្តាប់សេចក្តីណែនាំឱ្យចប់សិន។", listenStatus: "ស្ថានភាពការស្តាប់", male: "ប្រុស", female: "ស្រី", offline: "📴 គ្មានអ៊ីនធឺណិត — កំពុងបង្ហាញ TBM ដែលបានរក្សាទុក។ សូមធ្វើឱ្យស្រស់បន្ទាប់ពីបណ្តាញត្រឡប់មកវិញ។", playing: "កំពុងចាក់...", voiceLang: "ភាសាសំឡេង", signatureFailed: "មិនអាចរក្សាទុកហត្ថលេខាបានទេ", networkFailed: "មានបញ្ហាបណ្តាញពេលរក្សាទុកហត្ថលេខា។" },
    ph: { title: "Safety briefing", original: "Orihinal (Korean)", translated: "Salin", voice: "Makinig", signHere: "Pumirma rito", clear: "I-clear", confirm: "✍️ Kumpirmahin at pumirma", signed: "✓ Nakapirma na!", translating: "Isinasalin...", noTBM: "Walang briefing ngayon.", mustSign: "Aalis nang hindi pumipirma?", alreadySigned: "Nakapirma ka na ngayon.", back: "Bumalik", pron: "Pagbigkas", rev: "Balik-salin", listenFirst: "Pakinggan muna ang buong briefing.", listenStatus: "Katayuan ng pakikinig", male: "Lalaki", female: "Babae", offline: "📴 Offline — ipinapakita ang naka-save na TBM. I-refresh kapag bumalik ang network.", playing: "Pinapatugtog...", voiceLang: "Wika ng boses", signatureFailed: "Hindi na-save ang lagda", networkFailed: "Nagkaroon ng error sa network habang sine-save ang lagda." },
    id: { title: "Briefing keselamatan", original: "Asli (Korea)", translated: "Terjemahan", voice: "Dengarkan", signHere: "Tanda tangan di sini", clear: "Hapus", confirm: "✍️ Konfirmasi & tanda tangan", signed: "✓ Sudah ditandatangani!", translating: "Menerjemahkan...", noTBM: "Tidak ada briefing hari ini.", mustSign: "Keluar tanpa tanda tangan?", alreadySigned: "Anda sudah menandatangani hari ini.", back: "Kembali", pron: "Pelafalan", rev: "Terjemahan balik", listenFirst: "Silakan dengarkan briefing sampai selesai terlebih dahulu.", listenStatus: "Status mendengarkan", male: "Pria", female: "Wanita", offline: "📴 Offline — menampilkan TBM tersimpan. Segarkan setelah jaringan pulih.", playing: "Memutar...", voiceLang: "Bahasa suara", signatureFailed: "Gagal menyimpan tanda tangan", networkFailed: "Terjadi kesalahan jaringan saat menyimpan tanda tangan." },
    mn: { title: "Аюулгүй ажиллагааны заавар", original: "Эх (солонгос)", translated: "Орчуулга", voice: "Сонсох", signHere: "Энд гарын үсэг зурна уу", clear: "Цэвэрлэх", confirm: "✍️ Баталгаажуулж гарын үсэг зурах", signed: "✓ Гарын үсэг зурсан!", translating: "Орчуулж байна...", noTBM: "Өнөөдөр заавар байхгүй.", mustSign: "Гарын үсэггүй гарах уу?", alreadySigned: "Та өнөөдөр аль хэдийн гарын үсэг зурсан.", back: "Буцах", pron: "Дуудлага", rev: "Буцаан орчуулга", listenFirst: "Эхлээд зааврыг дуустал сонсоно уу.", listenStatus: "Сонссон төлөв", male: "Эрэгтэй", female: "Эмэгтэй", offline: "📴 Офлайн — хадгалсан TBM-г харуулж байна. Сүлжээ сэргээд шинэчилнэ үү.", playing: "Тоглуулж байна...", voiceLang: "Дууны хэл", signatureFailed: "Гарын үсгийг хадгалж чадсангүй", networkFailed: "Гарын үсгийг хадгалах үед сүлжээний алдаа гарлаа." },
    my: { title: "ဘေးကင်းရေး အကျဉ်းချုပ်", original: "မူရင်း (ကိုရီးယား)", translated: "ဘာသာပြန်", voice: "နားထောင်ရန်", signHere: "ဤနေရာတွင် လက်မှတ်ရေးပါ", clear: "ဖျက်ရန်", confirm: "✍️ အတည်ပြုပြီး လက်မှတ်ရေးရန်", signed: "✓ လက်မှတ်ရေးပြီးပါပြီ!", translating: "ဘာသာပြန်နေသည်...", noTBM: "ယနေ့ အကျဉ်းချုပ်မရှိပါ။", mustSign: "လက်မှတ်မရေးဘဲ ထွက်မလား?", alreadySigned: "ယနေ့ လက်မှတ်ရေးပြီးပါပြီ။", back: "နောက်သို့", pron: "အသံထွက်", rev: "နောက်ပြန်ဘာသာပြန်", listenFirst: "အကျဉ်းချုပ်ကို အဆုံးထိ နားထောင်ပါ။", listenStatus: "နားထောင်မှုအခြေအနေ", male: "ကျား", female: "မ", offline: "📴 အော့ဖ်လိုင်း — သိမ်းဆည်းထားသော TBM ကို ပြနေသည်။ ကွန်ရက်ပြန်ရသောအခါ ပြန်လည်ဖွင့်ပါ။", playing: "ဖွင့်နေသည်...", voiceLang: "အသံဘာသာ", signatureFailed: "လက်မှတ်ကို မသိမ်းဆည်းနိုင်ပါ", networkFailed: "လက်မှတ်သိမ်းဆည်းစဉ် ကွန်ရက်အမှားဖြစ်သည်။" },
    ne: { title: "सुरक्षा निर्देशन", original: "मूल (कोरियाली)", translated: "अनुवाद", voice: "सुन्नुहोस्", signHere: "यहाँ हस्ताक्षर गर्नुहोस्", clear: "खाली गर्नुहोस्", confirm: "✍️ पुष्टि गरी हस्ताक्षर गर्नुहोस्", signed: "✓ हस्ताक्षर भयो!", translating: "अनुवाद हुँदैछ...", noTBM: "आज कुनै निर्देशन छैन।", mustSign: "हस्ताक्षर नगरी बाहिरिने?", alreadySigned: "तपाईंले आज हस्ताक्षर गरिसक्नुभएको छ।", back: "फिर्ता", pron: "उच्चारण", rev: "उल्टो अनुवाद", listenFirst: "कृपया निर्देशन पूरा सुन्नुहोस्।", listenStatus: "सुन्ने स्थिति", male: "पुरुष", female: "महिला", offline: "📴 अफलाइन — सुरक्षित गरिएको TBM देखाइँदैछ। नेटवर्क आएपछि रिफ्रेस गर्नुहोस्।", playing: "चलिरहेको...", voiceLang: "आवाजको भाषा", signatureFailed: "हस्ताक्षर सुरक्षित गर्न सकिएन", networkFailed: "हस्ताक्षर सुरक्षित गर्दा नेटवर्क त्रुटि भयो।" },
    bn: { title: "নিরাপত্তা ব্রিফিং", original: "মূল (কোরিয়ান)", translated: "অনুবাদ", voice: "শুনুন", signHere: "এখানে স্বাক্ষর করুন", clear: "পরিষ্কার করুন", confirm: "✍️ নিশ্চিত করুন ও স্বাক্ষর করুন", signed: "✓ স্বাক্ষর সম্পন্ন!", translating: "অনুবাদ হচ্ছে...", noTBM: "আজ কোনো ব্রিফিং নেই।", mustSign: "স্বাক্ষর ছাড়া বের হবেন?", alreadySigned: "আপনি আজ স্বাক্ষর করেছেন।", back: "ফিরে যান", pron: "উচ্চারণ", rev: "বিপরীত অনুবাদ", listenFirst: "অনুগ্রহ করে পুরো ব্রিফিংটি আগে শুনুন।", listenStatus: "শোনার অবস্থা", male: "পুরুষ", female: "মহিলা", offline: "📴 অফলাইন — সংরক্ষিত TBM দেখানো হচ্ছে। নেটওয়ার্ক ফিরে এলে রিফ্রেশ করুন।", playing: "চলছে...", voiceLang: "ভয়েস ভাষা", signatureFailed: "স্বাক্ষর সংরক্ষণ করা যায়নি", networkFailed: "স্বাক্ষর সংরক্ষণের সময় নেটওয়ার্ক ত্রুটি হয়েছে।" },
    kk: { title: "Қауіпсіздік нұсқамасы", original: "Түпнұсқа (корейше)", translated: "Аударма", voice: "Тыңдау", signHere: "Осы жерге қол қойыңыз", clear: "Тазалау", confirm: "✍️ Растау және қол қою", signed: "✓ Қол қойылды!", translating: "Аударылуда...", noTBM: "Бүгін нұсқама жоқ.", mustSign: "Қол қоймай шығу керек пе?", alreadySigned: "Бүгін қол қойып қойдыңыз.", back: "Артқа", pron: "Айтылуы", rev: "Кері аударма", listenFirst: "Алдымен нұсқаманы соңына дейін тыңдаңыз.", listenStatus: "Тыңдау күйі", male: "Ер", female: "Әйел", offline: "📴 Офлайн — сақталған TBM көрсетілуде. Желі қалпына келген соң жаңартыңыз.", playing: "Ойнатылуда...", voiceLang: "Дауыс тілі", signatureFailed: "Қолтаңбаны сақтау сәтсіз", networkFailed: "Қолтаңбаны сақтау кезінде желі қатесі болды." },
    jp: { title: "安全ブリーフィング", original: "原文（韓国語）", translated: "翻訳", voice: "音声を聞く", signHere: "ここに署名してください", clear: "消去", confirm: "✍️ 確認して署名", signed: "✓ 署名済み！", translating: "翻訳中...", noTBM: "本日のブリーフィングはありません。", mustSign: "署名せずに退出しますか？", alreadySigned: "本日はすでに署名済みです。", back: "戻る", pron: "発音", rev: "逆翻訳", listenFirst: "先にブリーフィングを最後まで聞いてください。", listenStatus: "聴取状況", male: "男性", female: "女性", offline: "📴 オフライン — 保存済みのTBMを表示しています。通信回復後に更新してください。", playing: "再生中...", voiceLang: "音声言語", signatureFailed: "署名を保存できませんでした", networkFailed: "署名の保存中にネットワークエラーが発生しました。" },
    fr: { title: "Briefing de sécurité", original: "Original (coréen)", translated: "Traduction", voice: "Écouter", signHere: "Signez ici", clear: "Effacer", confirm: "✍️ Confirmer et signer", signed: "✓ Signé !", translating: "Traduction...", noTBM: "Aucun briefing aujourd’hui.", mustSign: "Quitter sans signer ?", alreadySigned: "Vous avez déjà signé aujourd’hui.", back: "Retour", pron: "Prononciation", rev: "Traduction inverse", listenFirst: "Veuillez écouter tout le briefing.", listenStatus: "État d’écoute", male: "Homme", female: "Femme", offline: "📴 Hors ligne — TBM enregistré affiché. Actualisez après le rétablissement du réseau.", playing: "Lecture...", voiceLang: "Langue vocale", signatureFailed: "Échec de l’enregistrement de la signature", networkFailed: "Erreur réseau lors de l’enregistrement de la signature." },
    es: { title: "Sesión de seguridad", original: "Original (coreano)", translated: "Traducción", voice: "Escuchar", signHere: "Firme aquí", clear: "Borrar", confirm: "✍️ Confirmar y firmar", signed: "✓ ¡Firmado!", translating: "Traduciendo...", noTBM: "No hay sesión hoy.", mustSign: "¿Salir sin firmar?", alreadySigned: "Ya firmó hoy.", back: "Volver", pron: "Pronunciación", rev: "Traducción inversa", listenFirst: "Escuche primero todo el briefing.", listenStatus: "Estado de escucha", male: "Hombre", female: "Mujer", offline: "📴 Sin conexión — se muestra el TBM guardado. Actualice cuando vuelva la red.", playing: "Reproduciendo...", voiceLang: "Idioma de voz", signatureFailed: "No se pudo guardar la firma", networkFailed: "Error de red al guardar la firma." },
    ar: { title: "إحاطة السلامة", original: "النص الأصلي (الكورية)", translated: "الترجمة", voice: "استمع", signHere: "وقّع هنا", clear: "مسح", confirm: "✍️ تأكيد وتوقيع", signed: "✓ تم التوقيع!", translating: "جارٍ الترجمة...", noTBM: "لا توجد إحاطة اليوم.", mustSign: "الخروج دون توقيع؟", alreadySigned: "لقد وقّعت اليوم بالفعل.", back: "رجوع", pron: "النطق", rev: "ترجمة عكسية", listenFirst: "يرجى الاستماع إلى الإحاطة كاملة أولاً.", listenStatus: "حالة الاستماع", male: "ذكر", female: "أنثى", offline: "📴 غير متصل — يتم عرض TBM المحفوظ. حدّث الصفحة بعد عودة الشبكة.", playing: "جارٍ التشغيل...", voiceLang: "لغة الصوت", signatureFailed: "تعذر حفظ التوقيع", networkFailed: "حدث خطأ في الشبكة أثناء حفظ التوقيع." },
    hi: { title: "सुरक्षा ब्रीफिंग", original: "मूल (कोरियाई)", translated: "अनुवाद", voice: "सुनें", signHere: "यहाँ हस्ताक्षर करें", clear: "साफ़ करें", confirm: "✍️ पुष्टि करें और हस्ताक्षर करें", signed: "✓ हस्ताक्षर हो गया!", translating: "अनुवाद हो रहा है...", noTBM: "आज कोई ब्रीफिंग नहीं है।", mustSign: "बिना हस्ताक्षर के बाहर निकलें?", alreadySigned: "आपने आज पहले ही हस्ताक्षर कर दिए हैं।", back: "वापस", pron: "उच्चारण", rev: "वापस अनुवाद", listenFirst: "कृपया पहले पूरी ब्रीफिंग सुनें।", listenStatus: "सुनने की स्थिति", male: "पुरुष", female: "महिला", offline: "📴 ऑफ़लाइन — सहेजा हुआ TBM दिखाया जा रहा है। नेटवर्क लौटने पर रीफ़्रेश करें।", playing: "चल रहा है...", voiceLang: "आवाज़ की भाषा", signatureFailed: "हस्ताक्षर सहेज नहीं सके", networkFailed: "हस्ताक्षर सहेजते समय नेटवर्क त्रुटि हुई।" },
                            ...
                            <section className="glass rounded-[48px] p-8 border-white/10 shadow-2xl relative overflow-hidden group">
                                ...
                                >
                                    <div className="flex items-center gap-1.5 mb-1">
                                        <span className="px-2 py-0.5 bg-blue-500 rounded-md text-[9px] font-black text-white animate-pulse">TTS</span>
                                        <span className="text-[9px] font-bold text-slate-500 italic uppercase">TTS 3.1</span>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        {isPlaying ? (
                                            <>
